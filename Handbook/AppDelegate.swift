...
class AppDelegate: UIResponder, UIApplicationDelegate {
  ...
  func makeView() {
    ...
    navigationBarAppearance.barTintColor = UIColor.flatBlackColor()
    ...
    navigationBarAppearance.tintColor = UIColor.whiteColor()
        ...
        tabBarAppearance.tintColor = UIColor.flatNavyBlueColor()
    let tabBarItemAppearance = UITabBarItem.appearance()
    tabBarItemAppearance.setTitleTextAttributes([NSForegroundColorAttributeName:UIColor.flatNavyBlueColor()], forState: UIControlState.Selected)
