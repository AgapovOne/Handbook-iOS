...
///
/// \param code An international country code (e.g 44 for the UK).
///
/// \returns  An optional array of ISO 639 compliant region codes.
- (NSArray<NSString *> * _Nullable)countriesForCode:(uint64_t)code;

/// Get an main ISO 639 compliant region code for a given country code.
///
/// \param code An international country code (e.g 1 for the US).
///
/// \returns  A ISO 639 compliant region code string.
- (NSString * _Nullable)mainCountryForCode:(uint64_t)code;
